...
void allEmpDetails(Employee* ep)
{
	...
	SalesManager* sp;
	sp = (SalesManager*)ep;
	cout << "\nIncentive is=" << sp->getIncentive();//downcasting //blind casting
	Admin* ap;
	ap = (Admin*)ep;
	cout << "\nAllowance is=" << ap->getAllowances();//downcasting //blind casting
	Hr* hp;
	hp = (Hr*)ep;
	cout << "\nCommission is=" << hp->getCommission();//downcasting //blind casting
}
